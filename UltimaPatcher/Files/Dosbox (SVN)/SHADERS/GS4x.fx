...
/*
   ...
   The gs4x shader processes a gfx. surface and tries to draw it 4x finer.
...
/*
  ...
  14.10.2007 by guest(r) - Some changes, diag. lines are displayed nicer.
...
string name : NAME = "GS4x";
string combinetechnique : COMBINETECHNIQUE =  "GS4x";
